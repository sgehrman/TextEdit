...
// NSDocumentController is subclassed to provide for modification of the open
// panel. Normally, there is no need to subclass the document controller.
@interface DocumentController : NSDocumentController

+ (NSView *)encodingAccessory:(NSUInteger)encoding
